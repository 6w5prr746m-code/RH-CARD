...
const DOMAIN_TAB_ORDER = [
  ...
  [DOMAIN.PREVENTION, DOMAIN_LABELS[DOMAIN.PREVENTION]],
  [DOMAIN.CONFORMITE, DOMAIN_LABELS[DOMAIN.CONFORMITE]],
  [DOMAIN.TRESORERIE, DOMAIN_LABELS[DOMAIN.TRESORERIE]],
  [DOMAIN.ARCHIVES, DOMAIN_LABELS[DOMAIN.ARCHIVES]],
  [DOMAIN.MOBILITE, DOMAIN_LABELS[DOMAIN.MOBILITE]],
  [DOMAIN.RESEAU, DOMAIN_LABELS[DOMAIN.RESEAU]],
  ['LEGEND', 'Légendaire'],
];
